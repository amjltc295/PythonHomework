...
def task_2(
    ...
    sentence = input_dictionary[target_key]
    # End of TODO
    input_list_length_and_sentence = (
        length,
        f'{input_list[target_index]}{sentence}'
    )
...
def task_7(
    ...
    student.set_words_to_say('Hellow lord!')
    # End of TODO
...
def task_8(
    img_url: str = 'https://http.cat/404'
) -> object:
    '''
    Task 8: Module
